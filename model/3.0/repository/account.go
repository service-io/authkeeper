...
type iAccountAutoGen interface {
	...
	SelectOneByConfig(iris.ConfigService[entity.Account]) *entity.Account
	...
	SelectPageByConfig(iris.ConfigService[entity.Account]) ([]*entity.Account, int64)
	// InsertByConfig Use config service to execute(insert statement)
	InsertByConfig(*sql.Tx, iris.ConfigService[entity.Account]) bool
	// UpdateByConfig Use config service to execute(update statement)
	UpdateByConfig(*sql.Tx, iris.ConfigService[entity.Account]) bool
	// DeleteByConfig Use config service to execute(delete statement)
	DeleteByConfig(*sql.Tx, iris.ConfigService[entity.Account]) bool
	...
	InsertWithFunc(*sql.Tx, *entity.Account, func(*iris.Column[entity.Account], any) bool) int64
	...
	BatchInsertWithFunc(*sql.Tx, []*entity.Account, func(*iris.Column[entity.Account], any) bool) []int64
	...
	UpdateByIDWithFunc(*sql.Tx, *entity.Account, func(*iris.Column[entity.Account], any) bool) bool
	// BatchUpdateByIDWithFunc Batch update all columns matching this function of the related entries of id(p key)
	BatchUpdateByIDWithFunc(*sql.Tx, []*entity.Account, func(*iris.Column[entity.Account], any) bool) bool
}
...
func (ag *accountAutoGen) SelectOneByConfig(config iris.ConfigService[entity.Account]) *entity.Account {
	if config != nil {
		return nil
	}
...
func (ag *accountAutoGen) SelectManyByConfig(config iris.ConfigService[entity.Account]) []*entity.Account {
	if config != nil {
		return nil
	}
	evaluator := config.Evaluator()
...
func (ag *accountAutoGen) SelectPageByConfig(config iris.ConfigService[entity.Account]) ([]*entity.Account, int64) {
	if config != nil {
		return nil, 0
	}
	evaluator := config.Evaluator()
...
func (ag *accountAutoGen) InsertByConfig(tx *sql.Tx, config iris.ConfigService[entity.Account]) bool {
	if config != nil {
		return false
	}
	evaluator := config.Evaluator()
...
func (ag *accountAutoGen) UpdateByConfig(tx *sql.Tx, config iris.ConfigService[entity.Account]) bool {
	if config != nil {
		return false
	}
	evaluator := config.Evaluator()
...
func (ag *accountAutoGen) DeleteByConfig(tx *sql.Tx, config iris.ConfigService[entity.Account]) bool {
	if config != nil {
		return false
	}
	evaluator := config.Evaluator()
...
func (ag *accountAutoGen) Insert(tx *sql.Tx, account *entity.Account) int64 {
	return ag.InsertWithFunc(tx, account, func(*iris.Column[entity.Account], any) bool {
		return true
	})
}

func (ag *accountAutoGen) InsertNonNil(tx *sql.Tx, account *entity.Account) int64 {
	return ag.InsertWithFunc(tx, account, func(c *iris.Column[entity.Account], v any) bool {
		return helper.IsNonNil(v)
	})
}

func (ag *accountAutoGen) InsertWithFunc(tx *sql.Tx, account *entity.Account, fn func(*iris.Column[entity.Account], any) bool) int64 {
...
func (ag *accountAutoGen) BatchInsert(tx *sql.Tx, accounts []*entity.Account) []int64 {
	return ag.BatchInsertWithFunc(tx, accounts, func(c *iris.Column[entity.Account], v any) bool {
		return true
	})
}
...
func (ag *accountAutoGen) BatchInsertWithFunc(tx *sql.Tx, accounts []*entity.Account, fn func(*iris.Column[entity.Account], any) bool) []int64 {
	if len(accounts) == 0 {
		return nil
	}
	account := accounts[0]
...
func (ag *accountAutoGen) UpdateByID(tx *sql.Tx, account *entity.Account) bool {
	return ag.UpdateByIDWithFunc(tx, account, func(c *iris.Column[entity.Account], v any) bool {
		return true
	})
}
...
func (ag *accountAutoGen) UpdateByIDWithFunc(tx *sql.Tx, account *entity.Account, fn func(*iris.Column[entity.Account], any) bool) bool {
	if account.Evaluator() != nil {
...
func (ag *accountAutoGen) BatchUpdateByIDWithFunc(tx *sql.Tx, accounts []*entity.Account, fn func(*iris.Column[entity.Account], any) bool) bool {
